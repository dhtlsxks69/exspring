...
<body>
	...
	<table border="1">
		<tbody>
		<tr><td>제목</td><td><input type="text" name="bbsTitle" value="${bbsVo.bbsTitle}" /></td></tr>
		<tr><td>내용</td><td><textarea rows="20" cols="80" name="bbsContent">${bbsVo.bbsContent}</textarea></td></tr>
